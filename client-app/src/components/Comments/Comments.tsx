            ...
            <div className="card">
              <div className="card-body p-4">
                <h4 className="text-start mb-4 pb-2">Comentarios</h4>
                    ...
                    setResCommentFail={setResCommentFail} setResCommentOk={setResCommentOk}
                    isReplying={isReplying} setIsReplying={setIsReplying} isEditing={isEditing} 
                    setIsEditing={setIsEditing} relatedCommentId={0} 
                    setComment={setComment} comment={comment} commentId={0}/>
                                                ...
                                                <div className="flex-grow-1 flex-shrink-1 mb-3">
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        {ct.userId === usuarioInfo.id ?
                                                                                 <ThreeDotsMenu setIsEditing={setIsEditing} setIsReplying={setIsReplying} setCommentId={setRootCommentId} commentId={ct.id}
                                                                        ...
                                                                        <div className="d-flex justify-content-between align-items-start">
                                                                            ...
                                                                            {users.map((user, index) => {
                                                                                ...
                                                                                {reply.userId === usuarioInfo.id ?
                                                                                 <ThreeDotsMenu setIsEditing={setIsEditing} setIsReplying={setIsReplying} setCommentId={setRootCommentId} commentId={reply.id}
                                                                                 comment={comment} setComment={setComment}/>
                                                                                 : null  
                                                                                }
                                                                        </div>
